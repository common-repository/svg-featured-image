    ...
    <form method="post" action="options.php">
        ...
        <table class="form-table">
            ...
            <tr valign="top">
                ...
                <td>
                    <span>uploads&nbsp;/&nbsp;</span>
                    <input type="text" name="SFI_NIRUS_PNG_FOLDER_PATH" value="<?php echo esc_attr(get_option('SFI_NIRUS_PNG_FOLDER_PATH')); ?>" placeholder="PNG Folder" required />
                </td>
            </tr>

            <tr valign="top">
                <th scope="row">Site Logo (HomePage)</th>
                <td>
                    <input type="text" name="SFI_NIRUS_PNG_SITE_LOGO_PATH" value="<?php echo esc_attr(get_option('SFI_NIRUS_PNG_SITE_LOGO_PATH')); ?>" placeholder="Paste Logo Link" required />
                </td>
            </tr>
            ...
            <tr valign="top">
                ...
                <td class="sfi-nirus-svg2png-td">
                    <div class="chkbox">
                        ...
                        <div class="chk-opt">
                            <span>&nbsp;Twitter&nbsp;</span>
                            <input type="checkbox" name="SFI_NIRUS_TWT_OPTION" id="SFI_NIRUS_TWT_OPTION" value="1" <?php checked('1', get_option('SFI_NIRUS_TWT_OPTION')); ?> />
                        </div>
                    </div>
                    ...
                    <div class="chkbox">
                        ...
                        <div class="chk-opt">
                            <span>&nbsp;Facebook&nbsp;</span>
                            <input type="checkbox" name="SFI_NIRUS_FB_OPTION" id="SFI_NIRUS_FB_OPTION" value="1" <?php checked('1', get_option('SFI_NIRUS_FB_OPTION')); ?> />
                        </div>
                    </div>
                </td>
            </tr>
